...
export class College extends Document { // Extend Document to create a Mongoose document
    ...
    // @Prop({ type: [BranchesDto], required: true }) // Define a property named 'branches' as an array of objects adhering to the BranchesDto schema
